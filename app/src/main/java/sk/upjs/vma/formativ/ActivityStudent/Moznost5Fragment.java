...
public class Moznost5Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_moznost5, container, false);
        context = view.getContext();

        textOtazky = (TextView) view.findViewById(R.id.nazovOtazky_Student_moznost5);
        moznost1 = (CheckBox) view.findViewById(R.id.moznost1_student_moznost5_checkBox);
        moznost2 = (CheckBox) view.findViewById(R.id.moznost2_student_moznost5_checkBox);
        moznost3 = (CheckBox) view.findViewById(R.id.moznost3_student_moznost5_checkBox);
        moznost4 = (CheckBox) view.findViewById(R.id.moznost4_student_moznost5_checkBox);
        moznost5 = (CheckBox) view.findViewById(R.id.moznost5_student_moznost5_checkBox);
        odpovedat = (Button) view.findViewById(R.id.odpovedat_moznost5_button);
    ...
    private void nastavPremenne() {
        if(otazka != null){
            ...
            moznost5.setText(spravnaOdpoved(otazka.getMoznost5()));
    ...
    private void spracujOdpoved() {
        ...
        if (moznost5.isChecked()){ odpovede.add(moznost5.getText().toString());}
