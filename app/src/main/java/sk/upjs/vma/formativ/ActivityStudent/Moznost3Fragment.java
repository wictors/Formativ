...
public class Moznost3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_moznost3, container, false);
        context = view.getContext();

        textOtazky = (TextView) view.findViewById(R.id.nazovOtazky_Student_moznost3);
        moznost1 = (CheckBox) view.findViewById(R.id.moznost1_student_moznost3_checkBox);
        moznost2 = (CheckBox) view.findViewById(R.id.moznost2_student_moznost3_checkBox);
        moznost3 = (CheckBox) view.findViewById(R.id.moznost3_student_moznost3_checkBox);
        odpovedat = (Button) view.findViewById(R.id.odpovedat_moznost3_button);
